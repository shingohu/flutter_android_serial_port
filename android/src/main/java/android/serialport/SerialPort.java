...
public class SerialPort {
    ...
    public SerialPort(File device, int baudrate, int stopBits, int dataBits, int parity, int flowCon, int flags)
        ...
        if (!device.exists()) {
            throw new IOException("serial port(" + device.getAbsolutePath() + ") not exists");
        }
        ...
        if (mFd == null) {
            throw new IOException("open native" +
                    " serial port(" + device.getAbsolutePath()
                    + ") returns null");
        }
        portPath = device.getAbsolutePath();
    ...
    public final static class Builder {
        ...
        public SerialPort build() throws SecurityException, IOException {
            return new SerialPort(device, baudrate, stopBits, dataBits, parity, flowCon, flags);
        }
    }
